...
namespace NGProjectAdmin.Service.Base
{
    ...
    /// 服务接口
    /// </summary>
    public interface INGAdminBaseService<T> where T :NGAdminBaseEntity
    {
        /// <summary>
        /// 分页查询
        /// </summary>
        ...
        /// <returns>执行结果</returns>
        ActionResult DeleteRange(Guid[] ids);
        ...
        /// <param name="ids">对象编号数组</param>
        /// <returns>执行结果</returns>
        ActionResult RemoveRange(Guid[] ids);
        ...
        /// <param name="ids">对象编号数组</param>
        /// <returns>执行结果</returns>
        Task<ActionResult> DeleteRangeAsync(Guid[] ids);
        ...
        /// <param name="ids">对象编号数组</param>
        /// <returns>执行结果</returns>
        Task<ActionResult> RemoveRangeAsync(Guid[] ids);
