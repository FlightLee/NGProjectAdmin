...
namespace NGProjectAdmin.WebApi.AppCode.FrameworkBase
{
    ...
    public class BaseController<T> : ControllerBase where T : BaseEntity
    {
        ...
        /// 服务层基类实例
        /// </summary>
        private readonly IBaseService<T> NGAdminBaseService;
        ...
        {
            this.NGAdminBaseService = BaseService;
        }
        ...
        [HttpDelete("{ids}")]
        [Log(OperationType.DeleteEntity)]
        public async Task<IActionResult> DeleteEntitiesByIds(int[] ids)
        {
            var actionResult = await this.NGAdminBaseService.DeleteRangeAsync(ids);
            return Ok(actionResult);
        }
